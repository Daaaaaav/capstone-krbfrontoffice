...
class ManagerUsers extends Component
{
    ...
    public function save()
    {
        ...
        try {
            ...
            if ($this->editMode) {
                ...
                if (!$role) {
                    throw new \Exception(
                        'Manager role not found in database'
                    );
                }
            ...
            $this->dispatch(
                ...
                type: 'error',
                title: 'Error',
                message: 'Failed to save manager: ' . $e->getMessage(),
                duration: 4000
            );
        }
    }
    ...
    public function render()
    {
        try {
            ...
            $stats = [
                ['label' => 'Total Managers', 'value' => $totalCount,    'key' => 'all'],
            ...
            $managers = $query->latest()->paginate(15);

            return view(
                'livewire.pages.it-officer.manager-users',
                compact('managers', 'stats')
            );
            ...
            return view(
                'livewire.pages.it-officer.manager-users',
                [
                    'managers' => User::where('user_id', 0)->paginate(15),
                    'stats' => [
                        ['label' => 'Total Managers', 'value' => 0, 'key' => 'all'],
