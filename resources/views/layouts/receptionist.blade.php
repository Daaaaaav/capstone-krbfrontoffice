...
>
    ...
    <div class="flex h-screen w-full overflow-hidden">
        ...
        <div class="flex-1 flex flex-col min-w-0 h-screen overflow-hidden bg-background relative">
            ...
            <main class="flex-1 overflow-y-auto overflow-x-hidden relative animate-fade-in-up transition-[padding] duration-300 ease-in-out pb-148 lg:pb-0" :style="isMobile ? 'padding-left: 0;' : (sidebarLocked ? 'padding-left: 280px;' : 'padding-left: 64px;')">
