...
>
    ...
    {{-- Drawer shell                                        --}}
    {{-- ═══════════════════════════════════════════════════ --}}
    <div class="fixed top-14 sm:top-auto bottom-[5rem] right-4 sm:right-6 w-[calc(100vw-2rem)] sm:w-full max-w-sm h-[70vh] max-h-[calc(100vh-8.5rem)] flex flex-col z-[70]">
